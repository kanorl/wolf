package com.frostwolf.common.concurrent.lock
...
private class OrderedLock<T>(unsorted: List<T>) : Lock where T : Lock, T : Comparable<T> {
    ...
    override fun unlock() {
        sorted.asReversed().forEach { it.unlock() }
    }
