...
import com.frostwolf.common.function.invoke
import com.frostwolf.common.logging.getLogger
import com.frostwolf.common.reflect.args
import com.frostwolf.common.reflect.safeGet
import com.frostwolf.io.*
import com.frostwolf.io.netty.*
...
class RequestHandlerManager : BeanPostProcessor {
        ...
        ReflectionUtils.doWithFields(type,
                {
                    ...
                    val typeArgs = it.type.args(func.javaClass)
                    ...
                    if (fieldIdentities.isNotEmpty()) {
                        ...
                        commandPermission += (command to listOf(Identity.Player::class.java))
                    }
    ...
    fun accessible(identity: Identity?, command: Command): Boolean {
        val i = identity ?: Identity.Unknown
